...
def check_deployment():
    ...
    try:
        ...
        st.error(f"""LLM is not working.  
            ...
            If you are using an Instructions based deployment (text-davinci-002), please check you have an environment variable OPENAI_DEPLOYMENT_TYPE=Text or delete the environment variable OPENAI_DEPLOYMENT_TYPE.  
